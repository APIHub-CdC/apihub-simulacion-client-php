...
class ApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetFullRCC()
    {
        ...
        try {
            ...
            echo 'Exception when calling RCC_ApiTest->testGetFullRCC: ', $e->getMessage(), PHP_EOL;
        }
    }

    public function testGetSegmentedRCC()
    {
        $x_full_report = false;
        $request = new PersonaPeticion();
        ...
        try {
            ...
            echo 'Exception when calling RCC_ApiTest->testGetSegmentedRCC: ', $e->getMessage(), PHP_EOL;
        }
    }
    ...
    public function testGetConsultas($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RCC_ApiTest->testGetConsultas: ', $e->getMessage(), PHP_EOL;
        }
    ...
    public function testGetCreditos($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RCC_ApiTest->testGetCreditos: ', $e->getMessage(), PHP_EOL;
        }
    }
    ...
    public function testGetDomicilios($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RCC_ApiTest->testGetDomicilios: ', $e->getMessage(), PHP_EOL;
        }
    }
    ...
    public function testGetEmpleos($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RCC_ApiTest->testGetEmpleos: ', $e->getMessage(), PHP_EOL;
        }
    }
    ...
    public function testGetMensajes($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RCC_ApiTest->testGetMensajes: ', $e->getMessage(), PHP_EOL;
        }
    }
}
