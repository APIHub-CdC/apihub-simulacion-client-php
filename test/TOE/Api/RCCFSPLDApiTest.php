...
class RCCFSPLDApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetReporte()
    {
        ...
        try {
            ...
            echo 'Exception when calling RCC_FS_PLD_ApiTest->testGetReporte: ', $e->getMessage(), PHP_EOL;
        }
    } 
    ...
    public function testGetConsultas($folioConsulta)
    {
        if($this->x_full_report == "false") {
            try {
                ...
                echo 'Exception when calling RCC_FS_PLD_ApiTest->testGetConsultas: ', $e->getMessage(), PHP_EOL;
            }
        } else {
    ...
    public function testGetCreditos($folioConsulta)
    {
        if($this->x_full_report == "false") {
            try {
                ...
                echo 'Exception when calling RCC_FS_PLD_ApiTest->testGetCreditos: ', $e->getMessage(), PHP_EOL;
            }
        } else {
            print_r("x_full_report inicializado en true");
        }        
    ...
    public function testGetDomicilios($folioConsulta)
    {
        if($this->x_full_report == "false") {
            try {
                ...
                echo 'Exception when calling RCC_FS_PLD_ApiTest->testGetDomicilios: ', $e->getMessage(), PHP_EOL;
            }
        } else {
            print_r("x_full_report inicializado en true");
        }          
    ...
    public function testGetEmpleos($folioConsulta)
    {
        if($this->x_full_report == "false") {
            try {
                ...
                echo 'Exception when calling RCC_FS_PLD_ApiTest->testGetEmpleos: ', $e->getMessage(), PHP_EOL;
            }
        } else {
            print_r("x_full_report inicializado en true");
        }          
    ...
    public function testGetScores($folioConsulta)
    {
        if($this->x_full_report == "false") {
            try {
                ...
                echo 'Exception when calling RCC_FS_PLD_ApiTest->testGetScores: ', $e->getMessage(), PHP_EOL;
            }
        } else {
            print_r("x_full_report inicializado en true");
        }         
    ...
    public function testGetMensajes($folioConsulta)
    {
        if($this->x_full_report == "false") {
            try {
                ...
                echo 'Exception when calling RCC_FS_PLD_ApiTest->testGetMensajes: ', $e->getMessage(), PHP_EOL;
            }
        } else {
            print_r("x_full_report inicializado en true");
        }         
