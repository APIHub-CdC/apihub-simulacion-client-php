...
class ApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetFullRC()
    {
        ...
        try {
            ...
            echo 'Exception when calling RC_ApiTest->testGetFullRC: ', $e->getMessage(), PHP_EOL;
        }
    }

    public function testGetSegmentedRC()
    {
        $x_full_report = false;
        $request = new PersonaPeticion();
        ...
        try {
            ...
            echo 'Exception when calling RC_ApiTest->testGetSegmentedRC: ', $e->getMessage(), PHP_EOL;
        }
    }
    ...
    public function testGetConsultas($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RC_ApiTest->testGetConsultas: ', $e->getMessage(), PHP_EOL;
        }
    ...
    public function testGetCreditos($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RC_ApiTest->testGetCreditos: ', $e->getMessage(), PHP_EOL;
        }
    }
    ...
    public function testGetDomicilios($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RC_ApiTest->testGetDomicilios: ', $e->getMessage(), PHP_EOL;
        }
    }
    ...
    public function testGetEmpleos($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RC_ApiTest->testGetEmpleos: ', $e->getMessage(), PHP_EOL;
        }
    }
    ...
    public function testGetMensajes($folioConsulta)
    {
        try {
            ...
            echo 'Exception when calling RC_ApiTest->testGetMensajes: ', $e->getMessage(), PHP_EOL;
        }
    }
}
